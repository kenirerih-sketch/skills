---
id: data-apis/token-api
title: 'Token API'
summary: 'Fetch token balances, metadata, and allowances without manual contract calls. Token API methods are exposed as Alchemy JSON-RPC methods.'
tags:
  - alchemy
  - data-apis
  - data
