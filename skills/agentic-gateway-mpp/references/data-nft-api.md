...
**Base URL**: `https://mpp.alchemy.com/{chainNetwork}/nft/v3/`
...
curl -s -H "Authorization: SIWE $TOKEN" \
  "https://mpp.alchemy.com/eth-mainnet/nft/v3/getNFTsForOwner?owner=0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045&withMetadata=true&pageSize=2"
```
...
```bash
curl -s -H "Authorization: SIWE $TOKEN" \
  "https://mpp.alchemy.com/eth-mainnet/nft/v3/getNFTMetadata?contractAddress=0xbc4ca0eda7647a8ab7c2061c2e118a18a936f13d&tokenId=1"
```
...
```bash
curl -s -H "Authorization: SIWE $TOKEN" \
  "https://mpp.alchemy.com/eth-mainnet/nft/v3/getContractMetadata?contractAddress=0xbc4ca0eda7647a8ab7c2061c2e118a18a936f13d"
```
...
```bash
curl -s -H "Authorization: SIWE $TOKEN" \
  "https://mpp.alchemy.com/eth-mainnet/nft/v3/getOwnersForContract?contractAddress=0xbc4ca0eda7647a8ab7c2061c2e118a18a936f13d&withTokenBalances=true"
```
...
```bash
curl -s -H "Authorization: SIWE $TOKEN" \
  "https://mpp.alchemy.com/eth-mainnet/nft/v3/getOwnersForNFT?contractAddress=0xbc4ca0eda7647a8ab7c2061c2e118a18a936f13d&tokenId=1"
```
...
```bash
curl -s -H "Authorization: SIWE $TOKEN" \
  "https://mpp.alchemy.com/eth-mainnet/nft/v3/getNFTsForContract?contractAddress=0xbc4ca0eda7647a8ab7c2061c2e118a18a936f13d&withMetadata=true&limit=2"
```
