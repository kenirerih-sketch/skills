...
**Base URL**: `https://mpp.alchemy.com/data/v1/`
...
```bash
curl -s -X POST "https://mpp.alchemy.com/data/v1/assets/tokens/balances/by-address" \
  -H "Content-Type: application/json" \
  -H "Authorization: SIWE $TOKEN" \
  -d '{
    "addresses": [{
...
```bash
curl -s -X POST "https://mpp.alchemy.com/data/v1/assets/nfts/by-address" \
  -H "Content-Type: application/json" \
  -H "Authorization: SIWE $TOKEN" \
  -d '{
    "addresses": [{
...
```bash
curl -s -X POST "https://mpp.alchemy.com/data/v1/assets/nfts/contracts/by-address" \
  -H "Content-Type: application/json" \
  -H "Authorization: SIWE $TOKEN" \
  -d '{
    "addresses": [{
...
```bash
curl -s -X POST "https://mpp.alchemy.com/data/v1/transactions/history/by-address" \
  -H "Content-Type: application/json" \
  -H "Authorization: SIWE $TOKEN" \
  -d '{
    "addresses": [{
