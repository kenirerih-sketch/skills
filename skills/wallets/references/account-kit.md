---
id: wallets/account-kit
title: 'Account Kit'
summary: 'Account Kit is Alchemy''s wallet SDK for onboarding users and managing wallet UX. Use it for embedded wallet flows or seamless authentication.'
tags:
  - alchemy
  - wallets
related:
...
- Pair with `gas-manager.md` for sponsored transactions.
