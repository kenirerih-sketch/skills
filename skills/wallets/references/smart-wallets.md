---
id: wallets/smart-wallets
title: 'Smart Wallets'
summary: 'Smart wallets (account abstraction) enable programmable accounts with features like session keys, batched transactions, and gas sponsorship.'
tags:
  - alchemy
  - wallets
related:
...
- Pair with `bundler.md` and `gas-manager.md`.
