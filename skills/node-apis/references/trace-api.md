---
id: node-apis/trace-api
title: 'Trace API'
summary: 'Trace APIs expose internal call data and state changes for transactions and blocks. Useful for analytics and auditing.'
tags:
  - alchemy
  - node-apis
  - evm
