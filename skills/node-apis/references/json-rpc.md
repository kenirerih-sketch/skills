---
id: node-apis/json-rpc
title: 'JSON-RPC (EVM)'
summary: 'Use Alchemy''s EVM JSON-RPC endpoints for standard blockchain reads and writes (e.g., `eth_call`, `eth_getLogs`, `eth_sendRawTransaction`). This is the baseline for any EVM integration.'
tags:
  - alchemy
  - node-apis
  - evm
  ...
  - json-rpc
related:
  - node-apis/enhanced-apis.md
  - data-apis/transfers-api.md
