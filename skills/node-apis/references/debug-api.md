---
id: node-apis/debug-api
title: 'Debug API'
summary: 'Debug methods provide execution-level traces for a transaction or call. Use these for simulation, gas profiling, and internal call inspection.'
tags:
  - alchemy
  - node-apis
  - evm
  - rpc
related:
  - node-apis/trace-api.md
  - data-apis/simulation-api.md
updated: 2026-02-05
---
# Debug API
