---
id: operational/auth-and-keys
title: 'Auth and API Keys'
summary: 'Alchemy uses API keys for most products. Keep keys server-side and scope them to environments.'
tags:
  - alchemy
  - operational
  - operations
