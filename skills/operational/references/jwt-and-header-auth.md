---
id: operational/jwt-and-header-auth
title: 'JWT and Header-Based Auth'
summary: 'Some Alchemy APIs use header-based auth (e.g., JWTs or API tokens) instead of API keys in URLs. Use this for server-side integrations where you need stronger access control.'
tags:
  - alchemy
  - operational
  - operations
