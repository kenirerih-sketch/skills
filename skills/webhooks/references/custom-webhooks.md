---
id: webhooks/custom-webhooks
title: 'Custom Webhooks (GraphQL)'
summary: 'Custom webhooks allow flexible event filtering using a GraphQL query hosted by Alchemy.'
tags:
  - alchemy
  - webhooks
  - webhook
